export const profile = {
  ...
  proof: [
    { value: "40+", label: "hours/month automated" },
...
export const capabilities = [
  {
    ...
    description:
      "Account segmentation, CRM hygiene, buyer-tier mapping, lead prioritization, funnel diagnostics, and leadership-ready account reporting layers.",
    tools: [
      "Power BI",
      "DAX",
      "SQL",
  ...
  },
  {
    ...
    description:
      "Campaign planning, audience targeting, ABM coordination, budget pacing, channel reporting, and cross-functional workflows that move accounts forward.",
    tools: [
      "Adobe Marketo",
      "MS Dynamics 365",
      "ActiveCampaign",
...
export const projects = [
  ...
  },
  {
    ...
    metrics: ["8 channels compared", "3.2x ROAS", "6.3 touches/deal"],
  },
  {
    number: "03",
    ...
    tools: "ETL, Dimensional Modeling, Power BI, Alerts",
